  ...
  Future<String> analyzeCv(String cvContent, {String? jobContext}) async {
    try {
      ...
      if (e.toString().contains('413')) {
        ...
        String shorterContent = '${cvContent.substring(0, cvContent.length > 2000 ? 2000 : cvContent.length)}... (texte considérablement tronqué en raison de limitations de taille)';
