...
class _CVState extends State<CV> {
  ...
  final CvImprovementService _cvService = GetIt.instance<CvImprovementService>();
  final PdfProcessingService _pdfService = GetIt.instance<PdfProcessingService>();
  ...
  static const Color indigo600 = Color(0xFF4F46E5); // Un peu plus vif que 6366F1
    ...
    try {
      ...
      if (result != null) {
        setState(() {
          ...
          _errorMessage = null;
          _extractedText = null;
          _recommendations = null; // Réinitialiser les recommandations lors du changement de fichier
        });
  ...
  Future<void> _extractTextFromFile() async {
    ...
    try {
      ...
      // Pour les autres formats (non supportés pour l'instant)
        ...
        text = "Format de fichier non pris en charge. Veuillez utiliser un fichier PDF ou TXT.";
      }
  ...
  Future<void> _analyzeCv() async {
    ...
    try {
      ...
      String optimizedText = _pdfService.prepareTextForAI(
        _extractedText!,
        jobContext: _jobContextController.text.isNotEmpty ? _jobContextController.text : null
      );
                    ...
                    children: [
                          ...
                          children: [
                            ...
                            Expanded(
                              child: Text(
                                ...
                                style: TextStyle(fontSize: 16, color: slate800, height: 1.5),
                              ),
                            ),
                          ],
                        ),
                      ...
                      GestureDetector(
                        ...
                        child: DragTarget<Object>(
                          ...
                          builder: (context, candidateData, rejectedData) {
                            bool isFileSuccessfullyProcessed = _extractedText != null && 
                                                              !_extractedText!.contains("ne contient pas de texte extractible") &&
                                                              !_extractedText!.contains("Format de fichier non pris en charge");
                            
                            Color borderColor = slate300;
                            if (_isDragging) {
                              borderColor = indigo600;
                            } else if (_fileName != null) {
                              borderColor = isFileSuccessfullyProcessed ? emerald500 : amber600;
                            }
                            ...
                            return AnimatedContainer(
                              ...
                              decoration: BoxDecoration(
                                color: _isDragging ? indigo50.withOpacity(0.5) : Colors.white,
                                borderRadius: BorderRadius.circular(16),
                                border: Border.all(
                                  color: borderColor,
                                  width: _isDragging || _fileName != null ? 2.5 : 1.5,
                                ),
                                boxShadow: [
                                  BoxShadow(
                              ...
                              child: Center( // Centrer le contenu
                                child: Padding( // Ajouter un padding interne
                                    ...
                                    children: [
                                      if (_fileName == null) ...[
                                        ...
                                        Container(
                                          padding: const EdgeInsets.all(20),
                                          decoration: BoxDecoration(
                                            color: isFileSuccessfullyProcessed ? emerald50 : amber50,
                                            shape: BoxShape.circle,
                                            border: Border.all(
                                              color: isFileSuccessfullyProcessed ? emerald500.withOpacity(0.3) : amber600.withOpacity(0.3),
                                              width: 2
                                            )
                                          ),
                                          child: isFileSuccessfullyProcessed
                                            ...
                                            : Icon(
                                                ...
                                                _isLoading && _extractedText == null ? Icons.hourglass_empty_rounded : Icons.warning_amber_rounded,
                                                size: 48, // Augmenté
                                                color: amber600,
                                              ),
                                        ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(
                              color: Colors.black.withOpacity(0.06), // Ombre plus subtile
                              blurRadius: 15,
                      ...
                      if (_errorMessage != null) ...[
                        ...
                        Container(
                          padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 20), // Padding ajusté
                          decoration: BoxDecoration(
                            color: red50, // Fond d'erreur plus doux
                            borderRadius: BorderRadius.circular(12),
                            border: Border.all(color: red600.withOpacity(0.5)), // Bordure plus subtile
                          ),
                          child: Row(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                      ...
                      if (_recommendations != null) ...[
                        const SizedBox(height: 40),
                        AnimatedOpacity( // Ajout d'une animation d'opacité
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: Colors.black.withOpacity(0.07), // Ombre plus subtile
                                  blurRadius: 20,
                                  offset: const Offset(0, 8),
                                ),
                              ],
                                ...
                                Row(
                                  children: [
                                    Container(
                                      ...
                                      decoration: BoxDecoration(
                                        color: amber50, // Couleur d'accent pour l'icône
                                        shape: BoxShape.circle,
